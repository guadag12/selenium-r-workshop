...
{{< video img/chromedriver_set_up.mp4 width="1200" height="650" >}}
...
#remDr <- remoteDriver( browser = "firefox")#remoteServerAddr = "localhost", port = 4567L, 
binman::list_versions("chromedriver")

driver <- rsDriver(browser = "chrome", port = 9515L, chromever = "114.0.5735.90")

# rD1 <- rsDriver(browser = "chrome", port = 4567L, geckover = NULL, 
#                chromever = "128.0.6613.121", iedrver = NULL, 
#                 phantomver = NULL)
remDr1 <- driver[["client"]] 
